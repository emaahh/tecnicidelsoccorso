        ...
        <Container maxWidth="xl">
          ...
          <Carousel swipe={true} navButtonsAlwaysVisible={true}>
            <Paper style={{borderRadius:"15px", overflow:"hidden", height:"45vh"}}>
                ...
                <img style={{height:'45vh', width:'100%', objectFit:"cover"}} src='https://www.tecnicidelsoccorso.it/wp-content/uploads/2018/09/seconda-no-testo.jpg'/>
                ...
                <div className='homeCorsoCard'>
                  ...
                  <br/>
                  <Chip color="error" label="Prenotati!" onClick={()=>alert('dd')} style={{fontSize:"17px", fontWeight:"bold"}}/>
                </div>
            ...
            <Paper style={{borderRadius:"15px", overflow:"hidden", height:"45vh"}}>
                ...
                <img style={{height:'45vh', width:'100%', objectFit:"cover"}} src='https://www.tecnicidelsoccorso.it/wp-content/uploads/2018/09/prima-no-testo.jpg'/>
          ...
          <center><h1 style={{fontWeight:"900", color:"#333333"}}>UN’ECCELLENZA SICILIANA</h1></center>
          <br/>
